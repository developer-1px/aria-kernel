...
export const defaultTreeviewCommands: readonly TreeCommandDescriptor[] = [
  ...
  { chord: 'alt+ArrowUp',   command: 'reorder-up',    description: 'Move focused item up among same-parent siblings',
    effect: { op: 'move', source: 'self', target: 'prevSibling', mode: 'sibling-before' } },
  { chord: 'alt+ArrowDown', command: 'reorder-down',  description: 'Move focused item down among same-parent siblings',
    effect: { op: 'move', source: 'self', target: 'nextSibling', mode: 'sibling-after' } },
